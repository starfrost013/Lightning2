...
namespace AnimTool
{
    public partial class MainForm : Form
    {
        ...
        private void loadJSONToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                NCError.ShowErrorBox("An error occurred while loading the JSON file.", 176, "An exception occurred in AnimTool::Load", NCErrorSeverity.Error);
        ...
        private void exportJSONToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                NCError.ShowErrorBox("An error occurred while saving the JSON file.", 177, "An exception occurred in AnimTool::Save", NCErrorSeverity.Error);
                return;
            }
        }
