...
namespace NuCore.Utilities
{
    ...
    public class NCMessageBox
    {
        ...
        public NCMessageBoxButton Show()
        {
            ...
            if (SDL.SDL_ShowMessageBox(ref mb_data, out button_id) < 0) _ = new NCException($"Error creating messagebox - {SDL.SDL_GetError}", 19, "NCMessageBox.Show()", NCExceptionSeverity.FatalError);
