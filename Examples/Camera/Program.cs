...
using static LightningBase.SDL; // for sdl 
...
while (Renderer.Run())
{
    ...
    PrimitiveRenderer.DrawText(Renderer, "Camera example", new Vector2(300, 300), Color.White); // no fonts loaded so we use the debug font
