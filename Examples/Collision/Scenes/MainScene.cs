...
namespace BasicScene
{
    public class MainScene : Scene
    {
        ...
        public override void SwitchTo(Scene? oldScene)
        {
            ...
            // draw text
            Lightning.Tree.AddRenderable(new TextBlock("Text3", "Collision/AABB example (NO correction is being done here)", "DebugFont", new Vector2(100, 100), Color.White)); // no fonts loaded so we use the debug font
        }
