...
namespace BasicScene
{
    public class MainScene : Scene
    {
        ...
        public override void SwitchTo(Scene? oldScene)
        {
            ...
            Lightning.Renderer.AddRenderable(new TextBlock("TextBlock1", "Primitive rendering example", "DebugFont", new Vector2(300, 300), Color.White)); // no fonts loaded so we use the debug font
        }
