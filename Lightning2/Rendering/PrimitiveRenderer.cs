...
namespace LightningGL
{
    ...
    public static class PrimitiveRenderer
    {
        ...
        public static void DrawLine(Window cWindow, Vector2 start, Vector2 End, short thickness, Color colour, bool antiAliased, bool snapToScreen = false)
        {
            ...
            if (thickness < 1) new NCException($"Cannot draw a line with a thickness property below 1 pixel! (thickness = {thickness})", 18, "PrimitiveRenderer.DrawLine!", NCExceptionSeverity.FatalError);
